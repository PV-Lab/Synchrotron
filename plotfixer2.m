function plotfixer(axisfontsize, legendfontsize,labelfontsize, titlefontsize)

%Plot Fixer
%plotfixer(axisfontsize, legendfontsize,labelfontsize, titlefontsize)
...
axislsize = 4; %thickness of tick marks and borders, in points
markersize = 4;  %size of line markers, default is 6
...
set(axesh, 'XMinorTick','on','YMinorTick','on');

set(axestexth, 'FontName', textfont)
set(axestexth, 'FontSize', textfontsize)

set(legendh, 'FontName', legendfont)
set(legendh, 'FontSize', legendfontsize)
set(legendh, 'FontWeight', legendfontweight)
